...
CONFIG = {
    ...
    'X_MOTOR': np.array([      3.005, 3.005, 2.999, 2.993, 2.995,  2.997,  2.998,  2.998, 2.999,  3.000,   3.000,  2.998, 2.997,  2.997,  2.998,  3.000,  3.003,  3.005, 3.0015,  3.000,  3.000,  2.999,  2.996, 2.994,  2.994, 2.9945,  2.972,  2.970,  2.960,  2.952,  2.956,  2.962,  2.9645]),
    'Y_MOTOR': np.array([      1.000, 1.000, 1.010, 1.010, 1.010,  1.010,  1.007,  1.006, 1.006,  1.007,  1.0065, 1.0062, 1.006, 1.0058, 1.0046, 1.0012, 1.0019, 1.0016,  1.000, 0.9987, 0.9987, 0.9987, 0.9985, 0.998, 0.9978,  0.997, 0.9975,  0.997, 0.9972, 0.9974, 0.9974, 0.9974,   0.997]),
