...
CONFIG = {
    ...
    'IMAGE_SIZE': 512,
    'SQUARE_COLOR': 'black',
    'SQUARE_SIZES': [512, 256, 128, 62, 40, 4],
    ...
    'Y_MOTOR': np.array([      1.000, 1.000, 1.010, 1.010, 1.010,  1.010,  1.007,  1.006, 1.006,  1.007,  1.0065, 1.0062, 1.006, 1.0058, 1.0046,  1.000, 1.0019, 1.0016,  1.000, 0.9987, 0.9987, 0.9987, 0.9975, 0.998, 0.9978,  0.997, 0.9975,  0.995, 0.9972, 0.9974, 0.9974, 0.9974,   0.997]),
